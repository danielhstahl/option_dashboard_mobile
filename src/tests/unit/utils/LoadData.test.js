...
describe('Render', () => {
  it('renders without error', () => {
    shallow(<LoadData onLoad={() => {}}>Hello World</LoadData>)
  })
})
describe('functionality', () => {
  it('calls function on mount', () => {
    ...
    shallow(<LoadData onLoad={onLoad}>Hello World</LoadData>)
  })
  it('calls function on mount and includes additional props', () => {
    ...
    shallow(
      <LoadData onLoad={onLoad} hello="goodbye">
        Hello World
      </LoadData>
    )
  })
